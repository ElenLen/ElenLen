...
**Основные технологии:**
`Angular` `RxJS` `State Management`, `JavaScript` `TypeScript` `React` `HTML5` `CSS3` `SASS/SCSS` `Responsive Web Design`

**Изучаю и применяю:**
`Angular` `RxJS` `State Management`

**Инструменты:**
`Git` `GitHub Actions` `Webpack` `Vite` `Figma` `Chrome DevTools` `VS Code`  `WebStorm`

---

## 🚀 Мои ключевые проекты

### [Сайт веб-студии на Angular](https://github.com/ElenLen/it-storm)
> **Описание:** Сайт веб-студии на Angular.

*   **Стек:** `TypeScript`, `Angular`, `HTML`, `SCSS`
*   **Особенности:** Использование RxJS, editor.swagger.io.
*   **Backend & Tools:** MongoDB - база данных, Postman - тестирование API
*   **Аутентификация:** Страница авторизации и регистрации пользователя, Валидация ввода данных
<!-- *   **Демо:** [Ссылка на живую демо-версию, если есть] -->

---

### [Игра на Vue.js "Крестики-нолики"](https://github.com/ElenLen/tic-tac-toe/tree/main)
> **Описание:** Игра создана в рамках ознакомления с основными возможностями фреймворка Vue.js.

*   **Стек:** `Vue.js`, `JavaScript`, `HTML`, `CSS`
<!-- *   **Демо:** [Ссылка на живую демо-версию, если есть] -->

---

### [Игра "Memory Game" на React](https://github.com/ElenLen/memorygame)
> **Описание:** Игра создана в качестве ознакомления с особенностями фреймворка React.
...
- [X] **Изучаю продвинутые паттерны** в TypeScript
- [X] **Практикую алгоритмы** и структуры данных
